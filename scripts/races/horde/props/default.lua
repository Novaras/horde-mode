...
String_Properties = {
	...
	path_build = [[data:scripts/races/horde/scripts/def_build.lua]],
	path_research = [[data:scripts/races/horde/scripts/def_research.lua]],
	path_ai = [[data:scripts/races/horde/scripts/def_ai.lua]],
	
	path_ai_special = [[data:scripts/races/horde/scripts/ai_special.lua]],
	path_ai_research = [[data:scripts/races/horde/scripts/ai_upgrades.lua]],
	path_ai_subsystems = [[data:scripts/races/horde/scripts/ai_subsystems.lua]],
	path_ai_build = [[data:scripts/races/horde/scripts/ai_build.lua]],
	
	path_crate_locate = [[data:scripts/races/horde/scripts/crate_locate.lua]],
	path_crate_ships = [[data:scripts/races/horde/scripts/crate_ships.lua]],
	
	def_type_mothership = "horde_mothership",
	def_type_carrier = "horde_carrier",
	def_type_scout = "horde_scout",
}
